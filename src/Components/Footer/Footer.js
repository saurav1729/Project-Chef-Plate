      ...
      <footer className="w-screen h-auto footer-bg  ">
        ...
        <div className="flex mobile:flex-row mobile:justify-around  flex-col">
          ...
          <div className="flex items-center justify-between mx-4 mobile:gap-4 gap-2">
            <input className="p-3 mobile:w-[16rem] w-[240px] mobile:mt-16  mt-5 outline-none text-[14px] text-[white] bg-[#ffffff40] placeholder:text-[#d66363]" type="email" placeholder="abc@gmail.com"></input>
            <button className="bg-[#03040550] hover:bg-[#030405] text-[#fff] mt-5 mobile:mt-16 p-3">Subscribe</button>
        ...
        <div className=' h-[3rem] w-[13.6rem]  text-white flex justify-between text-[1.25rem] font-Poppins font-[500] leading-[150%]'>
         ...
         <div className="mobile:h-[10rem] mobile:w-[13rem] h-[11rem] w-[300px] mobile:mx-0 mobile:mb-3 mx-auto my-5 rounded-2xl shadow-[#d66363] shadow-sm  blur-1 bg-[#ffffff09] hover:bg-[#F4572509] hover:shadow-[#ffffff09] text-[19px] font-serif text-[#ffffff70] p-4 ">
          <h3>Address:</h3>
          <p>KIIT,Patia</p>
          <p>Bhubaneswar</p>
          <p>Odisha(751024)</p>
