import { About_bg } from "../../Utils/about.png";

const About = () => {
  return (
  
    <div className="tablet:w-[100%] h-auto  mt-[80px] tablet:mt-0 tablet:h-auto tablet:relative bg-gradient-to-r  from-gray-dark  to-[#212020]   tablet:min-height tablet:-mb-[21rem] max-w-[1512px] mx-auto" >
    
        {/* <img className=" tablet:h-full tablet:w-full  " src={About_bg}></img> */}

      <div className=" tablet:w-[100%]  tablet:min-height">
        <h1 className=" ml-[30rem] mt-[6] tablet:text-[2rem] tablet:font-sans tablet:font-bold tablet:bg-gradient-to-bl tablet:from-[black] tablet:via-[#fc942b] tablet:to-[Orange] tablet:bg-clip-text tablet:text-[transparent] tablet:text-stroke tablet:text-stroke-indigo-200 tablet:text-stroke-fill-indigo-600">
        ...
        <div className="Features   tablet:mt-[26rem] tablet:ml-[1rem]">
        ...
        <div className="Features  tablet:mt-[26rem] tablet:right-0">
        ...
        <div className=" tablet:mt-[30rem] tablet:text-[1.3rem]  font-semibold tablet:ml-[38rem]">
         ...
         <p className=" tablet:p-3 tablet:shadow-sm tablet:rounded-md tablet:shadow-blue tablet:mt-[36rem] tablet:w-[37rem] tablet:ml-[30rem] text-pretty tablet:text-[1.34rem] text-[#ffffff90]">If you encounter shimmering UI instead of menus when clicking on restaurants, it's likely due to a CORS (Cross-Origin Resource Sharing) issue. To ensure uninterrupted access to our delectable offerings, we recommend using a VPN like Proton VPN.</p>

        <h2 className=" tablet:mt-[55rem] tablet:ml-[39rem] text-stroke tablet:p-2 shadow-sm shadow-gray-light rounded-2xl text-stroke-blue font-bold tablet:text-[3rem] ">Author:</h2>
     

        <div className="name  tablet:mt-[60rem] tablet:ml-[26rem] tablet:font-bold  tablet:text-[8rem] bg-gradient-to-r from-[#ae59d0] via-[#ed4e4e] to-[#6e6ef7] bg-clip-text text-[transparent] text-stroke text-stroke-[white] ">Saurav Jha</div>
          
          <div className=" tablet:w-[94%] rounded-2xl tablet:h-[9rem] bg-[#ffffff15] tablet:mt-[85rem] tablet:ml-[2rem]"></div>

          <p className=" tablet:mt-[86rem] tablet:ml-[4rem] text-[#ffffff50] tablet:w-[90%]">I'm Saurav Jha, a fervent explorer of the digital frontier, deeply immersed in the ever-evolving world of technology. My repertoire spans an array of programming languages, including C++, C, Python, JavaScript, React, HTML, CSS, and SQL. With a knack for touch typing and a typing speed exceeding 80 words per minute, I'm driven by the challenge of harnessing technology to address real-world challenges.</p>
           <span className=" tablet:mt-[91rem] tablet:ml-[4rem] text-[#ffffff90] "><b className="tablet:text-[1.3rem] text-stroke text-stroke-[#ed4e4e] ">Technologies:</b> C,C++,Java,Html,CSS,JavaScript,SQL</span> 
           <span className=" tablet:mt-[91rem] tablet:ml-[33rem] text-[#ffffff90]"><b className=" tablet:text-[1.3rem] text-stroke text-stroke-[#ed4e4e]">Typing Speed:</b> 80+ WPM</span>
      </div>
    </div>
