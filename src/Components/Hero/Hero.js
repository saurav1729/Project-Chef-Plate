...
const Hero = () => {
  return (
    ...
    >
      <div className="text-container mt-7 tablet:mt-0 text-center tablet:w-[50%] h-full w-full flex flex-col tablet:translate-y-14  text-pretty tablet:justify-around  relative tablet:text-animation tablet:mb-4 ">
        ...
        <div className="hero-style-container flex  justify-evenly ">
          ...
          <div className="inside-box flex flex-col justify-center w-auto tablet:h-auto h-[200px]">
            <div className="deliver-image rounded-[50%] w-[121px] h-[126px] mb-[22px] tablet:object-cover tablet:deliveryImage deliveryImageM z-10"></div>
