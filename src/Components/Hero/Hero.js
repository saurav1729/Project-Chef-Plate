    ...
    <div className="tablet:relative h-auto w-auto ">
        ...
        { showOptions &&<div className=' tablet:hidden absolute w-screen h-[330px] top-0 navbarAnimation transition-all ease-out duration-900   left-0 rounded-b-xl bg-[black] bg-opacity-90 bg-blur-sm  z-10' >
          <ul className=" flex flex-col justify-center text-center p-[30px] list-none   w-auto  text-xl font-bold gap-8    ">
              <li className="bg-gradient-to-r from-[red] to-orange bg-clip-text text-[transparent] font-bold cursor-pointer hover:text-[#fff] hover:scale-75 shadow-lg shadow-[#ac71a8] ] mobile:p-2 mobile:rounded-lg ">
                  <Link to="/">Home</Link>
              </li>
              <li className="bg-gradient-to-r from-[red] to-orange  bg-clip-text text-[transparent] hover:bg-purple hover:text-[#fff] hover:scale-75 font-bold cursor-pointer shadow-lg shadow-[#ac71a8]  mobile:p-2 mobile:rounded-lg">
                  <Link to="/about">About</Link>
              </li>
              <li className="bg-gradient-to-r from-[red] to-orange bg-clip-text text-[transparent] font-bold cursor-pointer hover:text-[#fff] hover:scale-75 shadow-lg shadow-[#ac71a8] mobile:p-2 mobile:rounded-lg ">
                  <Link to="/contact">Contact</Link>
              </li>
              <li className="bg-gradient-to-r from-[red] to-orange bg-clip-text text-[transparent] font-bold hover:text-[#fff] cursor-pointer hover:scale-75 hover:shadow-lg shadow-lg  shadow-[#ac71a8]   mobile:p-2 mobile:rounded-lg " onClick={() => {
