...
const Contact = () => {
  ...
  <form ref={form} onSubmit={sendEmail}>
    <div className="w-auto relative h-auto pb-5 mt-2 rounded-t-3xl tablet:rounded-none tablet:mt-[70px] bg-[#0B0D14] pt-5">
      ...
      <div className='h-auto w-[20rem] tablet:w-[30rem] bg-[#ffffff20] rounded-xl shadow-sm shadow-gray flex flex-col p-3'>
           ...
           <textarea className='  bg-[#ffffff40] p-2 placeholder:text-[#d66363] text-[white] text-[16px] w-[17rem] tablet:w-[27rem] rounded-lg outline-none' placeholder='abc...' name='message' ></textarea>
            <button type='submit' value='send' className='bg-[#00000080] text-[white] mt-[40px] p-3 rounded-xl  w-[10rem] hover:bg-[black] hover:text-[#ffffff50]' >Submit</button>
      </div>
      </div>
   </div>
   </form>
